...
class Matrix {
    ...
    Set<MatrixCoordinate> getSaddlePoints() {
        ...
        int[] tallestInRows = getTallestInRows();
        int[] shortestInColumns = getShortestInColumn(columns);
