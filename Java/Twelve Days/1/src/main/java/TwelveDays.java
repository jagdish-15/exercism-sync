class TwelveDays {
    private String[] song = new String[12];
    ...
    String sing() {
        int totalNumberOfVerses = 12;
        generateSongUptoVerse(totalNumberOfVerses);
        StringBuilder verses = new StringBuilder();
        for (int i = 0; i < totalNumberOfVerses; i++) {
            verses.append(song[i]).append(i == totalNumberOfVerses - 1? "\n": "\n\n");
        }
        return verses.toString();
    }
